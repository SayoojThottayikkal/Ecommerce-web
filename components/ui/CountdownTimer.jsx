...
const parseDuration = (input) => {
  const [amountStr, unitRaw] = input.trim().split(" ");
...
export default function CountdownTimer({ timeLeftString }) {
  const [remainingMs, setRemainingMs] = useState(parseDuration(timeLeftString));
